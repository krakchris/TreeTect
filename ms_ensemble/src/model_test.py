    ...
    with graph.as_default():
        with tf.Session() as sess:
            ...
            if 'detection_masks' in tensor_dict:
                ...
                # Reframe is required to translate mask \
                # from box coordinates to image coordinates and fit the image size.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", help="path to the output directory",
                        type=str)
    parser.add_argument("--model_file", help="path to the frozen grapg file \
                                            model file (.pb)on which testing needs to perform",
                        type=str)
